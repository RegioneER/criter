...
var dhtmlwindow={
imagefiles:['images/DragSet/min.gif', 'images/DragSet/close.gif', 'images/DragSet/restore.gif', 'images/DragSet/resize.gif'], //Path to 4 images used by script, in that order
...
init:function(t){
	...
	domwindowdata += '<img src="images/DragSet/DefaultIcon.gif" title="Icon" />&nbsp;&nbsp;<div class="drag-controls"><img src="' + this.imagefiles[0] + '" title="Minimize" /><img src="' + this.imagefiles[1] + '" title="Close" /></div>'
	domwindowdata+='</div>'
