<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Accumuli.ascx.cs" Inherits="WebUserControls_LibrettiImpianto_Accumuli" %>
...
<dx:ASPxGridView ID="grdPrincipale" runat="server" DataSourceID="dsGridPrincipale" AutoGenerateColumns="False" Width="100%" EnableRowsCache="False"
    KeyFieldName="IDLibrettoImpiantoAccumulo" 
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn>
            ...
            <DataItemTemplate>
                ...
                <b>Capacità</b>: <%# Eval("CapacitaLt") %> lt<br /><br />
                <table style="width:100%">
                    <tr>
                        <td>
                            <b>Acqua calda sanitaria</b>: <%# Convert.ToBoolean(Eval("fAcquaCalda"))?"SI":"NO" %><br />
                            <b>Riscaldamento</b>: <%# Convert.ToBoolean(Eval("fRiscaldamento"))?"SI":"NO" %><br />
                            <b>Raffreddamento</b> <%# Convert.ToBoolean(Eval("fRaffrescamento"))?"SI":"NO" %><br />
                        </td>
                        <td>
                            <b>Coibentazione presente</b>: <%# Convert.ToBoolean(Eval("fCoibentazionePresente"))?"SI":"NO" %>
                        </td>
                    </tr>
                </table>
            </DataItemTemplate>
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="CodiceProgressivo" Caption="Accumulo" VisibleIndex="4" Visible="false">
        ...
        <dx:GridViewDataSpinEditColumn FieldName="CapacitaLt" VisibleIndex="10" Visible="false">
            <EditFormSettings Visible="True" CaptionLocation="Top" />
            <EditFormSettings Caption="Capacità (Lt)" />
        ...
        <dx:GridViewDataColumn VisibleIndex="11" Visible="false">
            <EditFormSettings Visible="True" CaptionLocation="Top" />
            <EditFormSettings Caption="" />
            <EditItemTemplate>
                <dx:ASPxCheckBox ID="ASPxCheckBox1" runat="server" Value='<%# Bind("fAcquaCalda") %>' Text="Acqua calda sanitaria"></dx:ASPxCheckBox>
                <dx:ASPxCheckBox ID="ASPxCheckBox2" runat="server" Value='<%# Bind("fRiscaldamento") %>' Text="Riscaldamento"></dx:ASPxCheckBox>
                <dx:ASPxCheckBox ID="ASPxCheckBox3" runat="server" Value='<%# Bind("fRaffrescamento") %>' Text="Raffrescamento"></dx:ASPxCheckBox>
            </EditItemTemplate>
        </dx:GridViewDataColumn>
        <dx:GridViewDataCheckColumn FieldName="fCoibentazionePresente" VisibleIndex="12" Visible="false">
            <EditFormSettings Visible="True" CaptionLocation="Top" />
            <EditFormSettings Caption="Coibentazione presente?" />
...
<%--OnContextCreating="dsGridPrincipale_ContextCreating" OnContextDisposing="dsGridPrincipale_ContextDisposing"--%> 
<ef:EntityDataSource ID="dsGridPrincipale" runat="server" 
    ...
    EntitySetName="LIM_LibrettiImpiantiAccumuli"
