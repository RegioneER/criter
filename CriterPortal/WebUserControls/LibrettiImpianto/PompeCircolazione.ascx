<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PompeCircolazione.ascx.cs" Inherits="WebUserControls_LibrettiImpianto_PompeCircolazione" %>
<%@ Register assembly="DevExpress.Web.v16.2, Version=16.2.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web" tagprefix="dx" %>
<%@ Register TagPrefix="dxe" Namespace="DevExpress.Web" Assembly="DevExpress.Web.v16.2, Version=16.2.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" %>
...
<dx:ASPxGridView ID="grdPrincipale" runat="server" DataSourceID="dsGridPrincipale" AutoGenerateColumns="False" Width="100%" EnableRowsCache="False"
    KeyFieldName="IDLibrettoImpiantoPompaCircolazione" 
    ...
    OnRowValidating="grdPrincipale_OnRowValidating">
    <Columns>
        ...
        <dx:GridViewDataTextColumn>
            ...
            <DataItemTemplate>
                ...
                <b>Giri variabili</b>: <%# Convert.ToBoolean(Eval("fGiriVariabili"))?"Si":"No" %><br />
                <b>Potenza nominale</b>: <%# Eval("PotenzaNominaleKw") %> kW
            </DataItemTemplate>
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="CodiceProgressivo" Caption="Pompa" VisibleIndex="4" Visible="false">
        ...
        <dx:GridViewDataCheckColumn VisibleIndex="9" Visible="false" FieldName="fGiriVariabili" >
            <EditFormSettings Visible="True" CaptionLocation="Top" />
            <EditFormSettings Caption="Giri variabili" />
               <%-- <EditItemTemplate>
                     <dxe:ASPxRadioButton  id="fGiriVariabiliSi"  GroupName="radiofGiriVariabili" runat="server" checked='<%# Bind("fGiriVariabili") %>'  />  
                    <dxe:ASPxRadioButton  id="fGiriVariabiliNo"  GroupName="radiofGiriVariabili" runat="server" checked='<%# !(bool)Bind("fGiriVariabili") %>'  />  
                    </EditItemTemplate>--%>

          <%-- <EditItemTemplate>
              
                <%--<dx:ASPxRadioButtonList runat="server" ID="fGiriVariabili" RepeatDirection="Horizontal"
                     Value='<%# Convert.ToBoolean(Eval("fGiriVariabili")) %>' >
                   <Items>
                   <dx:ListEditItem Value="true" Text="Sì" />
                   <dx:ListEditItem Value="false" Text="No" />
                   </Items>
                </dx:ASPxRadioButtonList>--%>
                
              <%--  <dxe:ASPxRadioButton ID="radiofGiriVariabiliSi"  Layout="Flow" runat="server" GroupName="radiofGiriVariabili" Checked='<%#Bind("fGiriVariabili") %>'  />--%>
            
         <%--   </EditItemTemplate>--%>
        </dx:GridViewDataCheckColumn>
        
        <dx:GridViewDataSpinEditColumn FieldName="PotenzaNominaleKw" VisibleIndex="10" Visible="false">
            <EditFormSettings Visible="True" CaptionLocation="Top" />
            <EditFormSettings Caption="Potenza nominale (kW)" />
            <PropertiesSpinEdit MinValue="0" MaxValue="99999999" DecimalPlaces="2" DisplayFormatString="g" Width="100px">
                <ValidationSettings CausesValidation="True">
                    <RequiredField ErrorText="Inserire la potenza nominale" IsRequired="True" />
                </ValidationSettings>
            </PropertiesSpinEdit>
...
<ef:EntityDataSource ID="dsGridPrincipale" runat="server" 
    ...
    EntitySetName="LIM_LibrettiImpiantiPompeCircolazione"
