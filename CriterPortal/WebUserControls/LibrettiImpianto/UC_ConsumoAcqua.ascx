<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_ConsumoAcqua.ascx.cs" Inherits="UC_ConsumoAcqua" %>
...
<dx:ASPxGridView ID="grdPrincipale" runat="server" DataSourceID="dsGridPrincipale" AutoGenerateColumns="False" Width="100%" EnableRowsCache="False"
    KeyFieldName="IDLibrettiImpiantiConsumoAcqua" 
            ...
            <DataItemTemplate>
                <table width="100%" border="1" bordercolor="#dadcdb">
                    <tbody>
                        ...
                        <tr>
                            <td><b>Esercizio</b></td>
                            <td><b>Lettura iniziale</b></td>
                            <td><b>Lettura finale</b></td>
                            <td><b>Consumo totale</b></td>
                        </tr>
                        <tr>
...
<ef:EntityDataSource ID="dsGridPrincipale" runat="server" 
    ...
    EntitySetName="LIM_LibrettiImpiantiConsumoAcqua"
    AutoGenerateWhereClause="false"
    Where="it.IDLibrettoImpianto=@IDLibrettoImpianto"
    OrderBy="it.IDLibrettiImpiantiConsumoAcqua">
    <WhereParameters>
...
<ef:EntityDataSource ID="dsUnitaMisura" runat="server" 
    ...
    Where="it.fAttivo=true AND it.[IDUnitaMisura] IN {1,3}">
</ef:EntityDataSource>