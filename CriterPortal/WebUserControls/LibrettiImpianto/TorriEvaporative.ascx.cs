...
public partial class WebUserControls_LibrettiImpianto_TorriEvaporative : CriterUserControl
{
    public const string _Prefisso = "TE";
    ...
    {
        return CurrentDataContext.LIM_LibrettiImpiantiTorriEvaporative.Find(itemId).IDLibrettoImpiantoInserimento == IDLibrettoImpianto;
    }
    ...
    protected virtual void grdPrincipale_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        e.NewValues["CodiceProgressivo"] = LibrettoImpianto.LIM_LibrettiImpiantiTorriEvaporative.Count(l => l.fAttivo) + 1;
    ...
    protected void txtVentilatoreAltro_Init(object sender, EventArgs e)
    {
        ...
        panel.ClientVisible = keyValue != 0 && (CurrentDataContext.LIM_LibrettiImpiantiTorriEvaporative.Find(keyValue).IDTipologiaVentilatori == 1);
    }
    ...
    protected void grdPrincipale_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
    {
        ...
        if (e.ButtonID == "cmdSostituisci")
        {
            ...
            var gridElement = CurrentDataContext.LIM_LibrettiImpiantiTorriEvaporative.Find(idRiga);
            ...
            var replaceGridElement = new LIM_LibrettiImpiantiTorriEvaporative();
            ...
            replaceGridElement.CapacitaNominaleLt = gridElement.CapacitaNominaleLt;
            ...
            LibrettoImpianto.LIM_LibrettiImpiantiTorriEvaporative.Add(replaceGridElement);
    ...
    protected void grdPrincipale_RowUpdated(object sender, DevExpress.Web.Data.ASPxDataUpdatedEventArgs e)
    {
        ...
        if (!dataInstallazioneCorrente.Equals(dataInstallazionePrecedente))
        {
            ...
            var gridObject = CurrentDataContext.LIM_LibrettiImpiantiTorriEvaporative.Find(idRiga);

            var componenteSostituito = LibrettoImpianto.LIM_LibrettiImpiantiTorriEvaporative.Where(l => l.CodiceProgressivo == gridObject.CodiceProgressivo && l.fAttivo == false && l.DataDismissione.Equals(dataInstallazionePrecedente)).FirstOrDefault();
    ...
    protected void grdSostituzioni_BeforePerformDataSelect(object sender, EventArgs e)
    {
        ...
        var masterObject = CurrentDataContext.LIM_LibrettiImpiantiTorriEvaporative.Find(Convert.ToInt32(grid.GetMasterRowKeyValue()));
