...
public partial class UC_ConsumoProdottiChimici: CriterUserControl
{
    protected override bool IsDraftElementoGridPrincipale(int itemId)
    {
        return CurrentDataContext.LIM_LibrettiImpiantiConsumoProdottiChimici.Find(itemId).IDLibrettoImpianto == IDLibrettoImpianto;
    }
    ...
    protected void grdPrincipale_RowUpdated(object sender, DevExpress.Web.Data.ASPxDataUpdatedEventArgs e)
    {
        ...
        if (!dataEsercizioStart.Equals(dataEsercizioEnd))
        {
            ...
            var gridObject = CurrentDataContext.LIM_LibrettiImpiantiConsumoProdottiChimici.Find(idRiga);
    ...
    protected void grdSostituzioni_BeforePerformDataSelect(object sender, EventArgs e)
    {
        ...
        var masterObject = CurrentDataContext.LIM_LibrettiImpiantiConsumoProdottiChimici.Find(Convert.ToInt32(grid.GetMasterRowKeyValue()));
