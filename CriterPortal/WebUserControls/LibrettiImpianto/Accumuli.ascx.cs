...
public partial class WebUserControls_LibrettiImpianto_Accumuli : CriterUserControl
{
    public const string _Prefisso = "AC";
    ...
    {
        return CurrentDataContext.LIM_LibrettiImpiantiAccumuli.Find(itemId).IDLibrettoImpiantoInserimento == IDLibrettoImpianto;
    }
    ...
    protected virtual void grdPrincipale_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        e.NewValues["CodiceProgressivo"] = LibrettoImpianto.LIM_LibrettiImpiantiAccumuli.Count(l => l.fAttivo) + 1;
    ...
    protected void grdPrincipale_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
    {
        ...
        if (e.ButtonID == "cmdSostituisci")
        {
            ...
            var gridElement = CurrentDataContext.LIM_LibrettiImpiantiAccumuli.Find(idRiga);
            ...
            var replaceGridElement = new LIM_LibrettiImpiantiAccumuli();
            ...
            replaceGridElement.fAcquaCalda = gridElement.fAcquaCalda;
            replaceGridElement.fCoibentazionePresente = gridElement.fCoibentazionePresente;
            replaceGridElement.fRaffrescamento = gridElement.fRaffrescamento;
            replaceGridElement.fRiscaldamento = gridElement.fRiscaldamento;
            ...
            LibrettoImpianto.LIM_LibrettiImpiantiAccumuli.Add(replaceGridElement);
    ...
    protected void grdPrincipale_RowUpdated(object sender, DevExpress.Web.Data.ASPxDataUpdatedEventArgs e)
    {
        ...
        if (!dataInstallazioneCorrente.Equals(dataInstallazionePrecedente))
        {
            ...
            var gridObject = CurrentDataContext.LIM_LibrettiImpiantiAccumuli.Find(idRiga);

            var componenteSostituito = LibrettoImpianto.LIM_LibrettiImpiantiAccumuli.Where(l => l.CodiceProgressivo == gridObject.CodiceProgressivo && l.fAttivo == false && l.DataDismissione.Equals(dataInstallazionePrecedente)).FirstOrDefault();
    ...
    protected void grdSostituzioni_BeforePerformDataSelect(object sender, EventArgs e)
    {
        ...
        var masterObject = CurrentDataContext.LIM_LibrettiImpiantiAccumuli.Find(Convert.ToInt32(grid.GetMasterRowKeyValue()));
