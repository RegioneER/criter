<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AltriGeneratori.ascx.cs" Inherits="WebUserControls_LibrettiImpianto_AltriGeneratori" %>
...
<dx:ASPxGridView ID="grdPrincipale" runat="server" DataSourceID="dsGridPrincipale" AutoGenerateColumns="False" Width="100%" EnableRowsCache="False"
    KeyFieldName="IDLibrettoImpiantoAltroGeneratore" 
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn>
            ...
            <DataItemTemplate>
                ...
                <b>Potenza utile</b>: <%# Eval("PotenzaUtileKw") %> kW
            </DataItemTemplate>
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="CodiceProgressivo" Caption="Altro generatore" VisibleIndex="1" Visible="false">
        ...
        <dx:GridViewDataSpinEditColumn FieldName="PotenzaUtileKw" VisibleIndex="8" Visible="false">
            <EditFormSettings Visible="True" CaptionLocation="Top" />
            <EditFormSettings Caption="Potenza utile Kw" />
            <PropertiesSpinEdit MinValue="0" MaxValue="99999999" DecimalPlaces="2" DisplayFormatString="g" Width="100px">
                <ValidationSettings CausesValidation="True">
                    <RequiredField ErrorText="Inserire la potenza utile" IsRequired="True" />
                </ValidationSettings>
            </PropertiesSpinEdit>
...
<ef:EntityDataSource ID="dsGridPrincipale" runat="server" 
    ...
    EntitySetName="LIM_LibrettiImpiantiAltriGeneratori"
