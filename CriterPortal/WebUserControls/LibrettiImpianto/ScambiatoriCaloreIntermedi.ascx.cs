...
public partial class WebUserControls_LibrettiImpianto_ScambiatoriCaloreIntermedi : CriterUserControl
{
    ...
    {
        return CurrentDataContext.LIM_LibrettiImpiantiScambiatoriCaloreIntermedi.Find(itemId).IDLibrettoImpiantoInserimento == IDLibrettoImpianto;
    }
    ...
    protected virtual void grdPrincipale_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        e.NewValues["CodiceProgressivo"] = LibrettoImpianto.LIM_LibrettiImpiantiScambiatoriCaloreIntermedi.Count(l => l.fAttivo) + 1;
    ...
    protected void grdPrincipale_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
    {
        ...
        if (e.ButtonID == "cmdSostituisci")
        {
            ...
            var gridElement = CurrentDataContext.LIM_LibrettiImpiantiScambiatoriCaloreIntermedi.Find(idRiga);
            ...
            var replaceGridElement = new LIM_LibrettiImpiantiScambiatoriCaloreIntermedi();
            ...
            LibrettoImpianto.LIM_LibrettiImpiantiScambiatoriCaloreIntermedi.Add(replaceGridElement);
    ...
    protected void grdPrincipale_RowUpdated(object sender, DevExpress.Web.Data.ASPxDataUpdatedEventArgs e)
    {
        ...
        if (!dataInstallazioneCorrente.Equals(dataInstallazionePrecedente))
        {
            ...
            var gridObject = CurrentDataContext.LIM_LibrettiImpiantiScambiatoriCaloreIntermedi.Find(idRiga);

            var componenteSostituito = LibrettoImpianto.LIM_LibrettiImpiantiScambiatoriCaloreIntermedi.Where(l => l.CodiceProgressivo == gridObject.CodiceProgressivo && l.fAttivo == false && l.DataDismissione.Equals(dataInstallazionePrecedente)).FirstOrDefault();
    ...
    protected void grdSostituzioni_BeforePerformDataSelect(object sender, EventArgs e)
    {
        ...
        var masterObject = CurrentDataContext.LIM_LibrettiImpiantiScambiatoriCaloreIntermedi.Find(Convert.ToInt32(grid.GetMasterRowKeyValue()));
