<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TorriEvaporative.ascx.cs" Inherits="WebUserControls_LibrettiImpianto_TorriEvaporative" %>
...
<dx:ASPxGridView ID="grdPrincipale" runat="server" DataSourceID="dsGridPrincipale" AutoGenerateColumns="False" Width="100%" EnableRowsCache="False"
    KeyFieldName="IDLibrettoImpiantoTorreEvaporativa" 
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn>
            ...
            <DataItemTemplate>
                ...
                <b>Capacità nominale</b>: <%# Eval("CapacitaNominaleLt") %> lt<br />
        ...
        <dx:GridViewDataTextColumn FieldName="CodiceProgressivo" Caption="Torre" VisibleIndex="4" Visible="false">
        ...
        <dx:GridViewDataSpinEditColumn FieldName="CapacitaNominaleLt" VisibleIndex="10" Visible="false">
            <EditFormSettings Visible="True" CaptionLocation="Top" />
            <EditFormSettings Caption="Capacità nominale (Lt)" />
            <PropertiesSpinEdit MinValue="0" MaxValue="99999999" DecimalPlaces="2" DisplayFormatString="g" Width="100px">
                <ValidationSettings CausesValidation="True">
                    <RequiredField ErrorText="Inserire la capacità nominale" IsRequired="True" />
                </ValidationSettings>
            </PropertiesSpinEdit>
        </dx:GridViewDataSpinEditColumn>
        <dx:GridViewDataSpinEditColumn FieldName="VentilatoriNum" VisibleIndex="11" Visible="false">
            <EditFormSettings Visible="True" CaptionLocation="Top" />
...
<ef:EntityDataSource ID="dsGridPrincipale" runat="server" 
    ...
    EntitySetName="LIM_LibrettiImpiantiTorriEvaporative"
