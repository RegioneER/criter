...
public partial class WebUserControls_LibrettiImpianto_PompeCircolazione : CriterUserControl
{
    public const string _Prefisso = "PO";
    ...
    {
        return CurrentDataContext.LIM_LibrettiImpiantiPompeCircolazione.Find(itemId).IDLibrettoImpiantoInserimento == IDLibrettoImpianto;
    }
    ...
    protected virtual void grdPrincipale_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        e.NewValues["CodiceProgressivo"] = LibrettoImpianto.LIM_LibrettiImpiantiPompeCircolazione.Count(l => l.fAttivo) + 1;
    ...
    protected void grdPrincipale_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
    {
        ...
        if (e.ButtonID == "cmdSostituisci")
        {
            ...
            var gridElement = CurrentDataContext.LIM_LibrettiImpiantiPompeCircolazione.Find(idRiga);
            ...
            var replaceGridElement = new LIM_LibrettiImpiantiPompeCircolazione();
            ...
            replaceGridElement.fGiriVariabili = gridElement.fGiriVariabili;
            replaceGridElement.Modello = gridElement.Modello;
            replaceGridElement.PotenzaNominaleKw = gridElement.PotenzaNominaleKw;
            ...
            LibrettoImpianto.LIM_LibrettiImpiantiPompeCircolazione.Add(replaceGridElement);
    ...
    protected void grdPrincipale_RowUpdated(object sender, DevExpress.Web.Data.ASPxDataUpdatedEventArgs e)
    {
        ...
        if (!dataInstallazioneCorrente.Equals(dataInstallazionePrecedente))
        {
            ...
            var gridObject = CurrentDataContext.LIM_LibrettiImpiantiPompeCircolazione.Find(idRiga);

            var componenteSostituito = LibrettoImpianto.LIM_LibrettiImpiantiPompeCircolazione.Where(l => l.CodiceProgressivo == gridObject.CodiceProgressivo && l.fAttivo == false && l.DataDismissione.Equals(dataInstallazionePrecedente)).FirstOrDefault();
    ...
    protected void grdSostituzioni_BeforePerformDataSelect(object sender, EventArgs e)
    {
        ...
        var masterObject = CurrentDataContext.LIM_LibrettiImpiantiPompeCircolazione.Find(Convert.ToInt32(grid.GetMasterRowKeyValue()));
    ...
    protected void grdPrincipale_OnRowValidating(object sender, ASPxDataValidationEventArgs e)
    {
