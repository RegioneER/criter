...
public partial class WebUserControls_LibrettiImpianto_CircuitiInterrati : CriterUserControl
{
    public const string _Prefisso = "CI";
    ...
    {
        return CurrentDataContext.LIM_LibrettiImpiantiCircuitiInterrati.Find(itemId).IDLibrettoImpiantoInserimento == IDLibrettoImpianto;
    }
    ...
    protected virtual void grdPrincipale_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        e.NewValues["CodiceProgressivo"] = LibrettoImpianto.LIM_LibrettiImpiantiCircuitiInterrati.Count(l => l.fAttivo) + 1;
    ...
    protected void grdPrincipale_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
    {
        ...
        if (e.ButtonID == "cmdSostituisci")
        {
            ...
            var gridElement = CurrentDataContext.LIM_LibrettiImpiantiCircuitiInterrati.Find(idRiga);
            ...
            var replaceGridElement = new LIM_LibrettiImpiantiCircuitiInterrati();
            ...
            replaceGridElement.LunghezzaCircuitoMt = gridElement.LunghezzaCircuitoMt;
            replaceGridElement.ProfonditaInstallazioneMt = gridElement.ProfonditaInstallazioneMt;
            replaceGridElement.SuperficieScambiatoreMq = gridElement.SuperficieScambiatoreMq;
            ...
            LibrettoImpianto.LIM_LibrettiImpiantiCircuitiInterrati.Add(replaceGridElement);
    ...
    protected void grdPrincipale_RowUpdated(object sender, DevExpress.Web.Data.ASPxDataUpdatedEventArgs e)
    {
        ...
        if (!dataInstallazioneCorrente.Equals(dataInstallazionePrecedente))
        {
            ...
            var gridObject = CurrentDataContext.LIM_LibrettiImpiantiCircuitiInterrati.Find(idRiga);

            var componenteSostituito = LibrettoImpianto.LIM_LibrettiImpiantiCircuitiInterrati.Where(l => l.CodiceProgressivo == gridObject.CodiceProgressivo && l.fAttivo == false && l.DataDismissione.Equals(dataInstallazionePrecedente)).FirstOrDefault();
    ...
    protected void grdSostituzioni_BeforePerformDataSelect(object sender, EventArgs e)
    {
        ...
        var masterObject = CurrentDataContext.LIM_LibrettiImpiantiCircuitiInterrati.Find(Convert.ToInt32(grid.GetMasterRowKeyValue()));
