...
public partial class WebUserControls_LibrettiImpianto_ValvoleRegolazione : CriterUserControl
{
    public const string _Prefisso = "VR";
    ...
    {
        return CurrentDataContext.LIM_LibrettiImpiantiValvoleRegolazione.Find(itemId).IDLibrettoImpiantoInserimento == IDLibrettoImpianto;
    }
    ...
    protected virtual void grdPrincipale_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        e.NewValues["CodiceProgressivo"] = LibrettoImpianto.LIM_LibrettiImpiantiValvoleRegolazione.Count(l => l.fAttivo) + 1;
    ...
    protected void grdPrincipale_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
    {
        ...
        if (e.ButtonID == "cmdSostituisci")
        {
            ...
            var gridElement = CurrentDataContext.LIM_LibrettiImpiantiValvoleRegolazione.Find(idRiga);
            ...
            var replaceGridElement = new LIM_LibrettiImpiantiValvoleRegolazione();
            ...
            replaceGridElement.Servomotore = gridElement.Servomotore;
            replaceGridElement.VieNum = gridElement.VieNum;
            ...
            LibrettoImpianto.LIM_LibrettiImpiantiValvoleRegolazione.Add(replaceGridElement);
    ...
    protected void grdPrincipale_RowUpdated(object sender, DevExpress.Web.Data.ASPxDataUpdatedEventArgs e)
    {
        ...
        if (!dataInstallazioneCorrente.Equals(dataInstallazionePrecedente))
        {
            ...
            var gridObject = CurrentDataContext.LIM_LibrettiImpiantiValvoleRegolazione.Find(idRiga);

            var componenteSostituito = LibrettoImpianto.LIM_LibrettiImpiantiValvoleRegolazione.Where(l => l.CodiceProgressivo == gridObject.CodiceProgressivo && l.fAttivo == false && l.DataDismissione.Equals(dataInstallazionePrecedente)).FirstOrDefault();
    ...
    protected void grdSostituzioni_BeforePerformDataSelect(object sender, EventArgs e)
    {
        ...
        var masterObject = CurrentDataContext.LIM_LibrettiImpiantiValvoleRegolazione.Find(Convert.ToInt32(grid.GetMasterRowKeyValue()));
