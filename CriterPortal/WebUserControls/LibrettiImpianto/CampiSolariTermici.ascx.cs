...
public partial class WebUserControls_LibrettiImpianto_CampiSolariTermici : CriterUserControl
{
    public const string _Prefisso = "CS";
    ...
    public decimal SurfaceToCompare
    {
        get;
        set;
    }
    ...
    {
        return CurrentDataContext.LIM_LibrettiImpiantiCampiSolariTermici.Find(itemId).IDLibrettoImpiantoInserimento == IDLibrettoImpianto;
    }
    ...
    protected virtual void grdPrincipale_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        e.NewValues["CodiceProgressivo"] = LibrettoImpianto.LIM_LibrettiImpiantiCampiSolariTermici.Count(l => l.fAttivo) + 1;
    ...
    protected void grdPrincipale_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
    {
        ...
        if (e.ButtonID == "cmdSostituisci")
        {
            ...
            var gridElement = CurrentDataContext.LIM_LibrettiImpiantiCampiSolariTermici.Find(idRiga);
            ...
            var replaceGridElement = new LIM_LibrettiImpiantiCampiSolariTermici();
            ...
            replaceGridElement.CollettoriNum = gridElement.CollettoriNum;
            replaceGridElement.Fabbricante = gridElement.Fabbricante;
            replaceGridElement.SuperficieTotaleAperturaMq = gridElement.SuperficieTotaleAperturaMq;
            ...
            LibrettoImpianto.LIM_LibrettiImpiantiCampiSolariTermici.Add(replaceGridElement);
    ...
    protected void grdPrincipale_RowUpdated(object sender, DevExpress.Web.Data.ASPxDataUpdatedEventArgs e)
    {
        ...
        if (!dataInstallazioneCorrente.Equals(dataInstallazionePrecedente))
        {
            ...
            var gridObject = CurrentDataContext.LIM_LibrettiImpiantiCampiSolariTermici.Find(idRiga);

            var componenteSostituito = LibrettoImpianto.LIM_LibrettiImpiantiCampiSolariTermici.Where(l => l.CodiceProgressivo == gridObject.CodiceProgressivo && l.fAttivo == false && l.DataDismissione.Equals(dataInstallazionePrecedente)).FirstOrDefault();
    ...
    protected void grdSostituzioni_BeforePerformDataSelect(object sender, EventArgs e)
    {
        ...
        var masterObject = CurrentDataContext.LIM_LibrettiImpiantiCampiSolariTermici.Find(Convert.ToInt32(grid.GetMasterRowKeyValue()));
    ...
    protected void grdPrincipale_RowValidating(object sender, DevExpress.Web.Data.ASPxDataValidationEventArgs e)
    {
        ...
        if (e.NewValues["SuperficieTotaleAperturaMq"] != null &&
            Convert.ToDecimal(e.NewValues["SuperficieTotaleAperturaMq"]) != SurfaceToCompare)
        {
            AddError(e.Errors, grid.Columns["SuperficieTotaleAperturaMq"], 
                "La superficie totale di apertura deve corrispondere con il valore indicato al punto 1.5");
        }

        if (string.IsNullOrEmpty(e.RowError) && e.Errors.Count > 0)
            e.RowError = "Salvataggio non effettuato, la superficie totale di apertura deve corrispondere con il valore indicato al punto 1.5";
    }
