...
public partial class UC_ConsumoAcqua: CriterUserControl
{
    protected override bool IsDraftElementoGridPrincipale(int itemId)
    {
        return CurrentDataContext.LIM_LibrettiImpiantiConsumoAcqua.Find(itemId).IDLibrettoImpianto == IDLibrettoImpianto;
    }
    ...
    protected void grdSostituzioni_BeforePerformDataSelect(object sender, EventArgs e)
    {
        ...
        var masterObject = CurrentDataContext.LIM_LibrettiImpiantiConsumoAcqua.Find(Convert.ToInt32(grid.GetMasterRowKeyValue()));
