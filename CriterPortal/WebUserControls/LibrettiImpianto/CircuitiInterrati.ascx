<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CircuitiInterrati.ascx.cs" Inherits="WebUserControls_LibrettiImpianto_CircuitiInterrati" %>
...
<dx:ASPxGridView ID="grdPrincipale" runat="server" DataSourceID="dsGridPrincipale" AutoGenerateColumns="False" Width="100%" EnableRowsCache="False"
    KeyFieldName="IDLibrettoImpiantoCircuitoInterrato" 
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn>
            ...
            <DataItemTemplate>
                ...
                <b>Lunghezza circuito</b>: <%# Eval("LunghezzaCircuitoMt") %> m<br />
                <b>Superficie dello scambiatore</b>: <%# Eval("SuperficieScambiatoreMq") %> mq<br />
                <b>Profondità d'installazione</b>: <%# Eval("ProfonditaInstallazioneMt") %> m
            </DataItemTemplate>
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn FieldName="CodiceProgressivo" Caption="Circuito" VisibleIndex="4" Visible="false">
        ...
        <dx:GridViewDataSpinEditColumn FieldName="LunghezzaCircuitoMt" VisibleIndex="7" Visible="false">
            <EditFormSettings Visible="True" CaptionLocation="Top" ColumnSpan="2" />
            <EditFormSettings Caption="Lunghezza circuito (m)" />
            <PropertiesSpinEdit MinValue="0" MaxValue="99999999" DecimalPlaces="2" DisplayFormatString="g" Width="100px">
                <ValidationSettings CausesValidation="True">
                    <RequiredField ErrorText="Inserire la lunghezza del circuito" IsRequired="True" />
                </ValidationSettings>
            </PropertiesSpinEdit>
        </dx:GridViewDataSpinEditColumn>
        <dx:GridViewDataSpinEditColumn FieldName="SuperficieScambiatoreMq" VisibleIndex="8" Visible="false">
            <EditFormSettings Visible="True" CaptionLocation="Top" />
            <EditFormSettings Caption="Superficie dello scambiatore (mq)" />
            <PropertiesSpinEdit MinValue="0" MaxValue="99999999" DecimalPlaces="2" DisplayFormatString="g" Width="100px">
                <ValidationSettings CausesValidation="True">
                    <RequiredField ErrorText="Inserire la superficie dello scambiatore" IsRequired="True" />
                </ValidationSettings>
            </PropertiesSpinEdit>
        </dx:GridViewDataSpinEditColumn>
        <dx:GridViewDataSpinEditColumn FieldName="ProfonditaInstallazioneMt" VisibleIndex="9" Visible="false">
            <EditFormSettings Visible="True" CaptionLocation="Top" />
            <EditFormSettings Caption="Profondità d'installazione (m)" />
            <PropertiesSpinEdit MinValue="0" MaxValue="99999999" DecimalPlaces="2" DisplayFormatString="g" Width="100px">
                <ValidationSettings CausesValidation="True">
                    <RequiredField ErrorText="Inserire la profondità di installazione" IsRequired="True" />
                </ValidationSettings>
            </PropertiesSpinEdit>
        </dx:GridViewDataSpinEditColumn>
    </Columns>
...
<ef:EntityDataSource ID="dsGridPrincipale" runat="server" 
    ...
    EntitySetName="LIM_LibrettiImpiantiCircuitiInterrati"
