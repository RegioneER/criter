...
public partial class UC_ConsumoEnergiaElettrica: CriterUserControl
{
    protected override bool IsDraftElementoGridPrincipale(int itemId)
    {
        return CurrentDataContext.LIM_LibrettiImpiantiConsumoEnergiaElettrica.Find(itemId).IDLibrettoImpianto == IDLibrettoImpianto;
    }
    ...
    protected void grdPrincipale_RowUpdated(object sender, DevExpress.Web.Data.ASPxDataUpdatedEventArgs e)
    {
        ...
        if (!dataEsercizioStart.Equals(dataEsercizioEnd))
        {
            ...
            var gridObject = CurrentDataContext.LIM_LibrettiImpiantiConsumoEnergiaElettrica.Find(idRiga);
    ...
    protected void grdSostituzioni_BeforePerformDataSelect(object sender, EventArgs e)
    {
        ...
        var masterObject = CurrentDataContext.LIM_LibrettiImpiantiConsumoEnergiaElettrica.Find(Convert.ToInt32(grid.GetMasterRowKeyValue()));
