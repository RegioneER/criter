<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ScambiatoriCaloreIntermedi.ascx.cs" Inherits="WebUserControls_LibrettiImpianto_ScambiatoriCaloreIntermedi" %>
...
<dx:ASPxGridView ID="grdPrincipale" runat="server" DataSourceID="dsGridPrincipale" AutoGenerateColumns="False" Width="100%" EnableRowsCache="False"
    KeyFieldName="IDLibrettoImpiantoScambiatoreCaloreIntermedio" 
...
<ef:EntityDataSource ID="dsGridPrincipale" runat="server" 
    ...
    EntitySetName="LIM_LibrettiImpiantiScambiatoriCaloreIntermedi"
