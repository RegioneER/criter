...
public partial class WebUserControls_LibrettiImpianto_UC_VerifichePeriodicheGF : System.Web.UI.UserControl
{
    ...
    {
        var result = UtilityLibrettiImpianti.ListVerificheGF(IDTargaturaImpianto, prefisso);
