...
public partial class WebUserControls_LibrettiImpianto_AltriGeneratori : CriterUserControl
{
    public const string _Prefisso = "AG";
    ...
    {
        return CurrentDataContext.LIM_LibrettiImpiantiAltriGeneratori.Find(itemId).IDLibrettoImpiantoInserimento == IDLibrettoImpianto;
    }
    ...
    protected virtual void grdPrincipale_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        e.NewValues["CodiceProgressivo"] = LibrettoImpianto.LIM_LibrettiImpiantiAltriGeneratori.Count(l => l.fAttivo) + 1;
    ...
    protected void grdPrincipale_CustomButtonCallback(object sender, DevExpress.Web.ASPxGridViewCustomButtonCallbackEventArgs e)
    {
        ...
        if (e.ButtonID == "cmdSostituisci")
        {
            ...
            var gridElement = CurrentDataContext.LIM_LibrettiImpiantiAltriGeneratori.Find(idRiga);
            ...
            var replaceGridElement = new LIM_LibrettiImpiantiAltriGeneratori();
            ...
            replaceGridElement.PotenzaUtileKw = gridElement.PotenzaUtileKw;
            ...
            LibrettoImpianto.LIM_LibrettiImpiantiAltriGeneratori.Add(replaceGridElement);
    ...
    protected void grdPrincipale_RowUpdated(object sender, DevExpress.Web.Data.ASPxDataUpdatedEventArgs e)
    {
        ...
        if (!dataInstallazioneCorrente.Equals(dataInstallazionePrecedente))
        {
            ...
            var gridObject = CurrentDataContext.LIM_LibrettiImpiantiAltriGeneratori.Find(idRiga);

            var componenteSostituito = LibrettoImpianto.LIM_LibrettiImpiantiAltriGeneratori.Where(l => l.CodiceProgressivo == gridObject.CodiceProgressivo && l.fAttivo == false && l.DataDismissione.Equals(dataInstallazionePrecedente)).FirstOrDefault();
    ...
    protected void grdSostituzioni_BeforePerformDataSelect(object sender, EventArgs e)
    {
        ...
        var masterObject = CurrentDataContext.LIM_LibrettiImpiantiAltriGeneratori.Find(Convert.ToInt32(grid.GetMasterRowKeyValue()));
