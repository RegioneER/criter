<%@ Page Title="Criter - Iscrizione" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Iscrizione.aspx.cs" Inherits="Iscrizione" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentDisplay" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <!-- -->
            <asp:Table Width="900" ID="tblInfoAzienda" Visible="false" CssClass="TableClass" runat="server">
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="4" HorizontalAlign="Left" CssClass="riempimento1">
                        <h2>ISCRIZIONE AL SISTEMA CRITER</h2>
                    </asp:TableCell>
                </asp:TableRow>

                <%--<asp:TableRow runat="server" ID="rowParix" Visible="false">
                    <asp:TableCell ColumnSpan="4" Width="900" CssClass="riempimento">
                        Per agevolare le imprese di installazione e manutenzione nella fase di registrazione è disponibile un webservice mediante il quale sarà possibile compilare automaticamente il form di iscrizione in alcune sue parti inserendo la Partita IVA dell'impresa che si vuole accreditare e il Codice Fiscale del Legale Rappresentante nel box sottostante.
                        Se invece non si desideri usufruire del servizio sopradescritto procedere con la compilazione manuale del form di iscrizione
                        I dati relativi all'impresa saranno importati direttamente dalla piattaforma denominata <b>PARIX</b> che è la piattaforma di accesso ai dati del Registro delle Imprese, tenuto dalle Camere di Commercio italiane, che mette a disposizione delle Pubbliche Amministrazioni le informazioni aggiornate sulle imprese. 
                        Per poter importare i dati da tale piattaforma è necessario inserire nel box sottostante:<br />
                        <ul>
                            <li>inserire la Partita IVA dell'impresa</li>
                            <li>inserire il Codice Fiscale del Legale Rappresentante dell'impresa</li>
                            <li>fare click sul pulsante CERCA IMPRESA</li>
                        </ul>
                        <br />
                        <div class="boxParix">
                            <dx:ASPxTextBox ID="txtPartitaIvaParix" runat="server" MaxLength="11" Height="30px"
                                Border-BorderStyle="Solid" TabIndex="1" Width="200px"
                                NullText="Digita la Partita Iva dell'azienda">
                                <ValidationSettings ErrorDisplayMode="ImageWithTooltip" SetFocusOnError="true" ValidationGroup="vgParix" Display="Dynamic">
                                    <RequiredField IsRequired="true" ErrorText="Partita Iva obbligatoria" />
                                    <RegularExpression ErrorText="Partita Iva non valida" ValidationExpression="^[0-9]*$" />
                                </ValidationSettings>
                            </dx:ASPxTextBox>
                        </div>
                        <div class="boxParix">
                            <dx:ASPxTextBox ID="txtCodiceFiscaleParix" runat="server" MaxLength="16" Height="30px"
                                Border-BorderStyle="Solid" TabIndex="1" NullText="Digita il Codice fiscale del legale rappresentante" Width="270px">
                                <ValidationSettings ErrorDisplayMode="ImageWithTooltip" SetFocusOnError="true" ValidationGroup="vgParix" Display="Dynamic">
                                    <RequiredField IsRequired="true" ErrorText="Codice fiscale obbligatorio" />
                                    <RegularExpression ErrorText="Codice fiscale non valido" ValidationExpression="^[A-Za-z]{6}[0-9]{2}[A-Za-z]{1}[0-9]{2}[A-Za-z]{1}[0-9]{3}[A-Za-z]{1}$" />
                                </ValidationSettings>
                            </dx:ASPxTextBox>
                        </div>
                        <div class="boxParix">
                            <dx:ASPxButton ID="btnParix" runat="server" ValidationGroup="vgParix" TabIndex="1" CssClass="buttonClass" Width="200px"
                                OnClick="btnParix_Click" Text="CERCA IMPRESA">
                                <ClientSideEvents Click="function(s, e) {
	                                ParixPanel.Show();
	                                e.processOnServer = true;
                                }" />
                            </dx:ASPxButton>
                            <dx:ASPxLoadingPanel runat="server" ClientInstanceName="ParixPanel" Text="Ricerca impresa in corso..." Image-Url="~/images/loader.gif" Modal="True" />
                            <asp:Label ID="lblXmlParix" runat="server" Visible="false" />
                            <asp:ValidationSummary ID="vsParix" ValidationGroup="vgParix" runat="server" ShowMessageBox="True"
                                ShowSummary="False" HeaderText="Attenzione, ricontrollare i seguenti campi:"></asp:ValidationSummary>
                            <cc1:ModalPopupExtender ID="dmpParix" DropShadow="true" runat="server" Enabled="false" TargetControlID="btnParix"
                                PopupControlID="pnlParixConfirm" BackgroundCssClass="modalBackground" />
                            <asp:Panel ID="pnlParixConfirm" runat="server" Style="display: none; width: 400px; background-color: White; border-width: 1px; border-color: Black; border-style: solid;">
                                <asp:Label runat="server" ID="lblParixMessage" />
                                <br />
                                <br />
                                <div style="text-align: center;">
                                    <asp:Button ID="btnImportParix" runat="server" OnClick="btnImportParix_Click" CssClass="buttonClass" Width="100" Text="Ok" />
                                    <asp:Button ID="btnImportParixCancel" runat="server" OnClick="btnImportParixCancel_Click" CssClass="buttonClass" Width="100" Text="Annulla" />
                                </div>
                            </asp:Panel>
                        </div>
                        <div class="failureClass">
                            <asp:Label ID="lblMessage" CssClass="validation-error" runat="server" />
                        </div>
                    </asp:TableCell>
                </asp:TableRow>--%>
                ...
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="4" Width="900" CssClass="riempimento">
                        Compilare il form riportato prestando attenzione ai campi obbligatori contrassegnati da un asterisco e dai riquadri di colore giallo.
                        Completato l’inserimento dei dati fare click sul pulsante ISCRIZIONE.<br /><br />
                        <b>ATTENZIONE</b>: cliccando sul pulsante ISCRIZIONE i dati inseriti saranno salvati dal sistema e l’utente verrà re-indirizzato verso una nuova pagina dove potrà completare la registrazione.<br>
                        Pertanto non sarà possibile compilare nuovamente il form di iscrizione con gli stessi dati inseriti precedentemente. In tal caso comparirà un messaggio di errore che segnalerà che i dati sono già presenti nel sistema CRITER.
                    </asp:TableCell>
                </asp:TableRow>
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell Width="225" CssClass="riempimento">
                        <asp:TextBox runat="server" ID="txtIndirizzoSedeLegale" placeholder="" ClientIDMode="Static" Width="160" TabIndex="1" MaxLength="200" ValidationGroup="vgAnagrafica" CssClass="txtClass_o" />&nbsp;
                            <asp:TextBox runat="server" ID="txtNumeroCivicoSedeLegale" Width="30" TabIndex="1" MaxLength="10" ValidationGroup="vgAnagrafica" CssClass="txtClass_o" ToolTip="Numero Civico Sede Legale" />
                        <asp:RequiredFieldValidator
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell Width="225" CssClass="riempimento">
                        ...
                        <asp:RequiredFieldValidator
                            ...
                            ControlToValidate="txtCittaSedeLegale">&nbsp;*</asp:RequiredFieldValidator>
                    </asp:TableCell>
                    <asp:TableCell Width="225" CssClass="riempimento2">
                ...
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="4" Width="900" CssClass="riempimento">
                        <asp:TextBox ID="txtPrivacy" runat="server" TabIndex="1" Height="100" Rows="100" ReadOnly="true" TextMode="MultiLine" ToolTip="Privacy">
...
L’interessato che ritenga che il trattamento dei dati personali effettuato attraverso l’applicativo CRITER sia posto in essere in violazione di quanto previsto dal Reg. UE 2016/679 ha diritto di proporre reclamo all’Autorità Garante per la protezione dei dati personali, ai sensi dell’art. 77 Reg. UE 2016/679, ovvero di adire le competenti sedi giudiziarie ai sensi dell’art. 79 Reg. UE 2016/679.
                ...
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="4" HorizontalAlign="Center" CssClass="riempimento5">
                        <asp:Button ID="btnProcess" runat="server" ValidationGroup="vgAnagrafica" TabIndex="1" CssClass="buttonClass" Width="200"
                            OnClick="btnProcess_Click" Text="ISCRIZIONE" />
            ...
            <asp:Table Width="900" ID="tblInfoIspettore" Visible="false" CssClass="TableClass" runat="server">
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="4" HorizontalAlign="Left" CssClass="riempimento1">
                        <h2>RICHIESTA DI RICONOSCIMENTO QUALIFICA DI ISPETTORE IMPIANTI TERMICI</h2>
                    </asp:TableCell>
                </asp:TableRow>
                ...
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="4" HorizontalAlign="Left" CssClass="riempimento1">
                        <h2>DATI ANAGRAFICI ISPETTORE</h2>
                    </asp:TableCell>
                </asp:TableRow>
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell Width="225" CssClass="riempimento2">
                        <asp:Label runat="server" ID="lblPartitaIvaIspettore" AssociatedControlID="txtPartitaIvaIspettore" Text="Partita Iva (*)" />
                    </asp:TableCell>
                    <asp:TableCell Width="225" CssClass="riempimento">
                    ...
                    <asp:TableCell ColumnSpan="4" HorizontalAlign="Left" CssClass="riempimento">
                        ...
                        <asp:Table runat="server" ID="tblRequisitiIspettore" Width="890">
                            ...
                            <asp:TableRow ID="rowTitoloStudio" runat="server">
                                ...
                                <asp:TableCell>
                                    <asp:DropDownList ID="ddlTipologiaTitoloStudio" TabIndex="1" AutoPostBack="true" OnSelectedIndexChanged="ddlTipologiaTitoloStudio_SelectedIndexChanged" Width="200" runat="server" CssClass="selectClass_o" />
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell Width="675" ColumnSpan="3" CssClass="riempimento">
                        ...
                        <asp:RequiredFieldValidator ID="rfvUploadCurriculumVitae" runat="server"
                            EnableClientScript="true" ForeColor="Red" SetFocusOnError="true" ValidationGroup="vgAnagraficaIspettore"
                            ErrorMessage="Curriculum vitae .pdf: campo necessario"
                            ControlToValidate="UploadCurriculumVitae">&nbsp;*</asp:RequiredFieldValidator>
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell Width="675" ColumnSpan="3" CssClass="riempimento">
                        ...
                        <asp:RequiredFieldValidator ID="rfvUploadAttestatoCorso" runat="server"
                            EnableClientScript="true" ForeColor="Red" SetFocusOnError="true" ValidationGroup="vgAnagraficaIspettore"
                            ErrorMessage="Attestato di partecipazione al corso .pdf: campo necessario"
                            ControlToValidate="UploadAttestatoCorso">&nbsp;*</asp:RequiredFieldValidator>
...
L’interessato che ritenga che il trattamento dei dati personali effettuato attraverso l’applicativo CRITER sia posto in essere in violazione di quanto previsto dal Reg. UE 2016/679 ha diritto di proporre reclamo all’Autorità Garante per la protezione dei dati personali, ai sensi dell’art. 77 Reg. UE 2016/679, ovvero di adire le competenti sedi giudiziarie ai sensi dell’art. 79 Reg. UE 2016/679.
            ...
            <asp:Table Width="900" ID="tblInfoDistributoriCombustibile" Visible="false" CssClass="TableClass" runat="server">
                <asp:TableRow>
                    <asp:TableCell ColumnSpan="4" HorizontalAlign="Left" CssClass="riempimento1">
                        <h2>ISCRIZIONE AL SISTEMA CRITER</h2>
                    </asp:TableCell>
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell Width="225" CssClass="riempimento">
                        <asp:TextBox runat="server" ID="txtIndirizzoSedeLegaleDistributoriCombustibile" placeholder="" ClientIDMode="Static" Width="160" TabIndex="1" MaxLength="200" ValidationGroup="vgAnagrafica" CssClass="txtClass_o" />&nbsp;
...
L’interessato che ritenga che il trattamento dei dati personali effettuato attraverso l’applicativo CRITER sia posto in essere in violazione di quanto previsto dal Reg. UE 2016/679 ha diritto di proporre reclamo all’Autorità Garante per la protezione dei dati personali, ai sensi dell’art. 77 Reg. UE 2016/679, ovvero di adire le competenti sedi giudiziarie ai sensi dell’art. 79 Reg. UE 2016/679.
            ...
            <asp:Table Width="900" ID="tblInfoEnteLocale" Visible="false" CssClass="TableClass" runat="server">
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell Width="225" CssClass="riempimento">
                        <asp:TextBox runat="server" ID="txtIndirizzoSedeLegaleEnteLocale" placeholder="" ClientIDMode="Static" Width="160" TabIndex="1" MaxLength="200" ValidationGroup="vgAnagraficaEnteLocale" CssClass="txtClass_o" />&nbsp;
