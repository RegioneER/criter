...
namespace DataLayer
{
    ...
    public partial class LIM_LibrettiImpiantiCampiSolariTermici
    {
        public int IDLibrettoImpiantoCampoSolareTermico { get; set; }
        ...
        public Nullable<decimal> CollettoriNum { get; set; }
        public Nullable<decimal> SuperficieTotaleAperturaMq { get; set; }
