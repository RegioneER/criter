...
namespace DataLayer
{
    ...
    public partial class LIM_LibrettiImpiantiSistemiRegolazione
    {
        public int IDLibrettoImpiantoSistemaRegolazione { get; set; }
        ...
        public Nullable<decimal> PuntiRegolazioneNum { get; set; }
        public Nullable<decimal> LivelliTemperaturaNum { get; set; }
