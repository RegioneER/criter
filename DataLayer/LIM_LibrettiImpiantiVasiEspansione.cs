...
namespace DataLayer
{
    ...
    public partial class LIM_LibrettiImpiantiVasiEspansione
    {
        public int IDLibrettoImpiantoVasoEspansione { get; set; }
        ...
        public Nullable<decimal> PressionePrecaricaBar { get; set; }
