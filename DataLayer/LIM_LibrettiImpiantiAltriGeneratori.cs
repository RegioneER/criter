...
namespace DataLayer
{
    ...
    public partial class LIM_LibrettiImpiantiAltriGeneratori
    {
        public int IDLibrettoImpiantoAltroGeneratore { get; set; }
        ...
        public Nullable<decimal> PotenzaUtileKw { get; set; }
