...
namespace DataLayer
{
    ...
    public partial class LIM_LibrettiImpiantiPompeCircolazione
    {
        public int IDLibrettoImpiantoPompaCircolazione { get; set; }
        ...
        public Nullable<bool> fGiriVariabili { get; set; }
        public Nullable<decimal> PotenzaNominaleKw { get; set; }
