...
namespace DataLayer
{
    ...
    public partial class SYS_SorgenteLatoEsterno
    {
        public SYS_SorgenteLatoEsterno()
        {
            this.LIM_LibrettiImpiantiMacchineFrigorifere = new HashSet<LIM_LibrettiImpiantiMacchineFrigorifere>();
        }
    
        public int IDSorgenteLatoEsterno { get; set; }
        public string SorgenteLatoEsterno { get; set; }
