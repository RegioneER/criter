...
namespace DataLayer
{
    ...
    public partial class LIM_LibrettiImpiantiValvoleRegolazione
    {
        public int IDLibrettoImpiantoValvolaRegolazione { get; set; }
        ...
        public Nullable<decimal> VieNum { get; set; }
